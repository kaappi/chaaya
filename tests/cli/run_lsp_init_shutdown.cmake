...
if(NOT out MATCHES "\"completionProvider\"")
  message(FATAL_ERROR "missing completionProvider capability in output: ${out}")
endif()
if(NOT out MATCHES "\"hoverProvider\":true")
  message(FATAL_ERROR "missing hoverProvider capability in output: ${out}")
endif()
if(NOT out MATCHES "\"referencesProvider\":true")
  message(FATAL_ERROR "missing referencesProvider capability in output: ${out}")
endif()
if(NOT out MATCHES "\"definitionProvider\":true")
  message(FATAL_ERROR "missing definitionProvider capability in output: ${out}")
endif()
if(NOT out MATCHES "\"documentSymbolProvider\":true")
  message(FATAL_ERROR "missing documentSymbolProvider capability in output: ${out}")
endif()
